...
-- CreateEnum
CREATE TYPE "Permissions" AS ENUM ('FULL_ACCESS', 'OPEN_FILE', 'DELETE_FILE', 'UPLOAD_FILE', 'RENAME_FILE', 'DOWNLOAD_FILE', 'MOVE_FILE', 'COPY_FILE', 'SHARE_FILE', 'CREATE_FOLDER', 'OPEN_FOLDER', 'RENAME_FOLDER', 'MOVE_FOLDER', 'COPY_FOLDER', 'UPLOAD_FOLDER', 'DELETE_FOLDER', 'SHARE_FOLDER');
