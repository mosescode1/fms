...
-- CreateEnum
CREATE TYPE "Action" AS ENUM ('CREATE', 'READ', 'UPDATE', 'DELETE', 'RESTORE', 'MOVE', 'COPY', 'SHARE');

-- CreateEnum
CREATE TYPE "ResourceType" AS ENUM ('FOLDER', 'FILE');

-- CreateEnum
CREATE TYPE "Permissions" AS ENUM ('FULL_ACCESS', 'READ', 'WRITE', 'EXECUTE', 'UPLOAD', 'DOWNLOAD', 'RENAME', 'MOVE', 'COPY', 'OPEN_FILE', 'DELETE_FILE', 'SHARE_FILE', 'CREATE_FOLDER', 'OPEN_FOLDER', 'DELETE_FOLDER', 'SHARE_FOLDER', 'ARCHIVE', 'RESTORE', 'MANAGE_PERMISSIONS', 'MANAGE_USERS', 'MANAGE_ROLES');
